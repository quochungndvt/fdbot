...
var model = process.env.model || 'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/c413b2ef-382c-45bd-8ff0-f76d60e2a821?subscription-key=51a31d0dbb524776b68e9c606c249483';
...
//               context.message.text, // the user's message
...
//               intent = { score: 1.0, intent: context };
//               done(null, intent);
//             })
//             .catch((err) => {
...
bot.dialog('/', [
    function (session) {
        ...
        //     .title("Homefinder Bot")
        //     .text('Homefinder xin chào, mình là một chatbot đơn giản được sinh ra để giải quyết nhu cầu về bất động sản của bạn. Nào! bắt đầu thôi ')
        //     .images([
